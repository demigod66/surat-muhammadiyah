                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                ...
                                <form action="{{ url('instansi/update', $instansi->id) }}" class="form-horizontal"
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nama" id="nama" class="form-control"
                                                    value="{{ $instansi->nama }}" maxlength="15">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <img src="{{ asset('uploads/logo/' . $instansi->file) }}"
